...
// DefaultConfig returns the default configuration for Clotho.
func DefaultConfig() *Config {
	// Determine the base path for the workspace.
	// Priority: $CLOTHO_HOME > ~/.clotho
	var homePath string
	if clothoHome := os.Getenv("CLOTHO_HOME"); clothoHome != "" {
		homePath = clothoHome
	} else {
		userHome, _ := os.UserHomeDir()
		homePath = filepath.Join(userHome, ".clotho")
	}
